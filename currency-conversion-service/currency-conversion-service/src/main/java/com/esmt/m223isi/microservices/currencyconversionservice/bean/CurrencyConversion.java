...
public class CurrencyConversion {
	...
	public CurrencyConversion(long id, String from, String to, BigDecimal rateExchange,
			BigDecimal amount, BigDecimal calculateAmount, String source, String environnement)
	{
		super();
		this.id = id;
		this.from = from;
